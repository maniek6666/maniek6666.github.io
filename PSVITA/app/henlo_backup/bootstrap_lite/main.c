...
#define REPO_URL "http://maniek6666.github.io/tree/main/PSVITA/app/VPK/"
...
#define QAD_VPK_FNAME "Vita.APP.Instaler.vpk"
...
#define BOOTSTRAP_VERSION_STR "VITA APP INSTALER"
...
int install_qad() {
    ...
    COLORPRINTF(COLOR_CYAN, "Pobieranie\n");
    net(1);
...
int download_661() {
    ...
    COLORPRINTF(COLOR_CYAN, "Pobieranie oprogramowania 6.61 dla Adrenaline\n");
    net(1);
